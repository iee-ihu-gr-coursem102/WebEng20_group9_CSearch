...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark" >
            ...
            <a class="navbar-brand" href="#">mu

                <svg width=".7em" height="1em" viewBox="0 0 16 16" 
                     class="bi bi-music-note" fill="currentColor" 
                     xmlns="http://www.w3.org/2000/svg">
                <path d="M9 13c0 1.105-1.12 2-2.5 2S4 14.105 4 13s1.12-2 2.5-2 2.5.895 2.5 2z"/>
                <path fill-rule="evenodd" d="M9 3v10H8V3h1z"/>
                <path d="M8 2.82a1 1 0 0 1 .804-.98l3-.6A1 1 0 0 1 13 2.22V4L8 5V2.82z"/>
                </svg>i<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-moon" 
                            fill="currentColor" 
                            xmlns="http://www.w3.org/2000/svg">
...
<!--class="btn btn-primary-->
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header btn-primary">
                            <h1 class="modal-title " id="terms_title"></h1>
                        ...
                        <div class="modal-body">
                            <div class="en section_container" section-language="en">
                                ...
                                <div id="md_en" data-target="out_en" class="agreement_md">
                                    ...
                                    <p>This Privacy Policy describes Our policies and procedures on the                                         collection,                                         use and disclosure of Your information when You use the Service and tells 
                                    ...
                                    <p>We use Your Personal data to provide and improve the Service. 
                                        ...
                                        the <a href="https://www.termsfeed.com/privacy-policy-generator/" 
                                               target="_blank">Privacy Policy Generator</a>.</p>
                                    <h1 id="h1">Interpretation and Definitions</h1>
                                    <h2>Interpretation</h2>
                                    <p>The words of which the initial letter i
                                        s capitalized have meanings defined under the following conditions. 
                                    ...
                                    <ul>
                                        <li>
                                            <p><strong>Account</strong> means a 
                                                unique account created for You to access our Service or parts of our Service.</p>
                                        </li>
                                        <li>
                                            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to kjkj.</p>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <p><strong>Website</strong> refers to kjkj, accessible from <a href="cssks" rel="external nofollow noopener" target="_blank">cssks</a></p>
                                        </li>
                                        <li>
        ...
        <script type="text/javascript">
            $('#terms_title').text("Terms of Use")
            $('#terms_modal').modal({backdrop: 'static', keyboard: false})

            console.log("font size:" + document.getElementById("h1").style.fontSize)
